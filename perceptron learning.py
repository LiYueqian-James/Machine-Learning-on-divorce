...
def run(train_stat,train_label, test_stat, test_label):
    shuffle1 = np.random.permutation(len(train_stat))
    train_stat = train_stat[shuffle1]
    train_label = train_label[shuffle1]
    shuffle2 = np.random.permutation(len(test_label))
    test_stat = test_stat[shuffle2]
    test_label = test_label[shuffle2]
